  ...
  render(){
    return ( 
        <div className="col-xs-6 col-sm-3">
            ...
            <div className="padder-v"> <Link to={this.props.song? "/song/"+this.props.song.dashed_title+"/"+this.props.song._id  : "#"} className="text-ellipsis">{this.props.song? this.props.song.title : ""}</Link> <Link to={this.props.song? "/user/"+this.props.song.artist.artistUserName  : "#"} className="text-ellipsis text-xs text-muted">{this.props.song? this.props.song.artist.artistName : ""}</Link>
            </div>
            </div>
        </div>
    );
